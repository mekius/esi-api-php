...
/**
 * GetCharactersCharacterIdSkillqueue200OkObject Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetCharactersCharacterIdSkillqueue200OkObject implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'get_characters_character_id_skillqueue_200_ok_object';
    ...
    public function setFinishedLevel($finishedLevel)
    {
        ...
        if (($finishedLevel > 5.0)) {
            throw new \InvalidArgumentException('invalid value for $finishedLevel when calling GetCharactersCharacterIdSkillqueue200OkObject., must be smaller than or equal to 5.0.');
        }
        if (($finishedLevel < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $finishedLevel when calling GetCharactersCharacterIdSkillqueue200OkObject., must be bigger than or equal to 0.0.');
        }
