...
/**
 * GetSovereigntyCampaigns200OkObject Class Doc Comment
 *
 * @category    Class */
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetSovereigntyCampaigns200OkObject implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'get_sovereignty_campaigns_200_ok_object';
    ...
    protected static $swaggerTypes = [
        ...
        'defenderScore' => 'float',
        'eventType' => 'string',
        'participants' => '\ESI\Model\GetSovereigntyCampaignsParticipant[]',
        'solarSystemId' => 'int',
        'startTime' => '\DateTime',
        'structureId' => 'int'
    ];
    ...
    /**
     * Gets participants
     * @return \ESI\Model\GetSovereigntyCampaignsParticipant[]
     */
    ...
    /**
     * Sets participants
     * @param \ESI\Model\GetSovereigntyCampaignsParticipant[] $participants Alliance participating and their respective scores, only present in Freeport Events.
     * @return $this
     */
